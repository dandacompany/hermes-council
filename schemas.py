...
START_SCHEMA = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "relay": {"type": "string",
                      "description": "Relay each speech to a gateway messenger channel as it happens. Target syntax matches `hermes send --to`: 'slack' (home channel), 'slack:#council', 'telegram:-1001234567890:17585'. Off when omitted — meeting content goes to the channel verbatim."},
